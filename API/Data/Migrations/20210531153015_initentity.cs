        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastestUpdate = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "TEXT", nullable: true),
                    Title = table.Column<string>(type: "TEXT", nullable: true),
                    ReleaseLetterNo = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubPolices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubPolices_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SubPolices_Policies_PolicyId",
                        column: x => x.PolicyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubPolices_Code",
                table: "SubPolices",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SubPolices_CreatedById",
                table: "SubPolices",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_SubPolices_PolicyId",
                table: "SubPolices",
                column: "PolicyId");
        }
